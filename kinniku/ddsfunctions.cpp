...
HRESULT CreateTextureFromDdsRgbImage(ID3D11DeviceContext *pContext, DDS_HEADER *pddsc, VOID *pBuffer, ID3D11Texture2D **ppTexture);
HRESULT CreateTextureFromDdsLinearImage(ID3D11DeviceContext *pContext, DDS_HEADER *pddsc, DXGI_FORMAT fmt, VOID *pBuffer, DWORD dwLinearSize, ID3D11Texture2D **ppTexture);
